...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            ...
            <a class="nav-item nav-link active" href="Park">Parco Auto <span class="sr-only">(current)</span></a>
            <c:if test="${usern.tipologia == 'Admin'}">
...
<div style="text-align: center;">
    ...
    <h4>
        <c:url var="link" value="Operation">
            ...
            <c:param name="tipo" value="auto">
            </c:param>
        </c:url>
<c:if test="${usern.tipologia == 'Admin'}">
        <a href="${link}">Aggiungi Nuove Auto</a>
</c:if>
    </h4>
</div>
<div align="center">
...
<%--                        <c:param name="id" value='${auto.getId()}'>--%>
<%--                        </c:param>--%>
<%--                        <c:param name="action" value="auto">--%>
<%--                        </c:param>--%>
<%--                    </c:url>--%>
<%--                    <a class="btn btn-warning" href="${linkInvia1}">Multe</a>--%>

<%--                    &nbsp;&nbsp;--%>
<%--                    <a class="btn btn-outline-info" href="delete?id=<c:out value='${auto.getId()}' />">Prenotazioni</a>--%>
                </td>
                </c:if>
            </tr>
        </c:forEach>
